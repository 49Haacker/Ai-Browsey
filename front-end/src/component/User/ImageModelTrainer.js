      ...
      <div className="d-flex mt-5">
        <div className="row w-100 m-0">
          <div className="col-md-3">
            <div className="card">
              ...
              <div className="card-body" style={{ height: '90vh', overflow: 'auto' }}>
                <label>Select Images To Train</label>
                <input type="file" className="form-control" multiple onChange={loadClientImages} />
                <div className="row mt-4">
                  <div className="col-md-6">
                    {imageList1.map((image, index) => (
                      <img src={`/traningImages/${image}`} id={image} width="224" height="224" />
                    ))}
                  </div>
                </div>
              </div>
          ...
          <div className="col-md-9">
            <div className="col-lg-4 mb-4 mb-lg-0 text-center w-100 pb-3" style={{ backgroundColor: 'red' }}>
              <h2>class</h2>
            </div>
            <div className="row row-cols-4 g-3 pt-2">
              ...
              <div className="col">
                <div className="card">
                  <img src="https://mdbcdn.b-cdn.net/img/new/standard/city/043.webp" className="card-img-top" alt="Palm Springs Road" />
                  <div className="card-body">
                    <h5 className="card-title">Card title</h5>
                    <p className="card-text">This is a longer card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
                  </div>
